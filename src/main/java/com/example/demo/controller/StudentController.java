...
public class StudentController {
    ...
    public Result<PageResult<Student>> getStudentPage(
        ...
        IPage<Student> page = studentService.getStudentPage(pageNum, pageSize, name, studentNo, classId);
        PageResult<Student> result = PageResult.of(page.getRecords(), page.getTotal(), pageNum, pageSize);
